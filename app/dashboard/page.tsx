...
const monthlyExpensesData = [
  { category: 'المواد', amount: 250000 },
  { category: 'الرواتب', amount: 180000 },
  { category: 'المصروفات', amount: 120000 },
  { category: 'الإيجارات', amount: 80000 },
  { category: 'أخرى', amount: 50000 },
]
...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      ...
      <Card>
        <CardHeader>
          <CardTitle>المصروفات الشهرية حسب الفئة</CardTitle>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
